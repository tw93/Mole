...
show_clean_help() {
    ...
    echo "  --only LIST       Clean only these sections (comma-separated)"
    echo "  --skip LIST       Clean everything except these sections"
    echo "  --list-sections   Show the section keys --only and --skip accept"
