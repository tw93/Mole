...
require_match "docs/launch/launch-strategy.md" '^# Launch Strategy$' "launch strategy must exist"
require_match "docs/launch/launch-strategy.md" 'Clean your Mac[.] See every change[.]' "launch strategy must state product promise"
require_match "docs/launch/launch-strategy.md" 'Do not sell proprietary CLI feature gates' "launch strategy must preserve support-based pricing"
require_match "docs/launch/launch-strategy.md" 'public repository and Homebrew tap use .jake-seo-cl/roomy. and .jake-seo-cl/homebrew-tap.' "launch strategy must name canonical distribution namespace"
require_match "docs/launch/launch-strategy.md" 'check-distribution-prereqs[.]sh --check-secrets' "launch strategy must include external distribution prerequisite gate"
require_match "docs/launch/distribution-automation.md" 'check-distribution-prereqs[.]sh --check-secrets' "distribution automation must document external prerequisite check"
require_match "docs/launch/go-no-go-audit.md" 'Distribution prerequisites exist' "go/no-go audit must require external distribution prerequisite evidence"
require_match "scripts/check-distribution-prereqs.sh" '^Usage: scripts/check-distribution-prereqs[.]sh' "distribution prerequisite checker must exist"
