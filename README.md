...
- **Simulator Runtime Volumes**: In `mo clean` -> Developer tools, Mole can list CoreSimulator `Volumes/Cryptex` entries with `IN_USE/UNUSED` status and let you select cleanup items interactively.
